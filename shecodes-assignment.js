...
function formatDate(now) {
  ...
  let months = ["Janaury","February","March","April","May","June","July","August","September","October","November","Decemeber"];
...
function searchCity(city) {
  ...
  axios.get(`${apiUrl}&appid=${apiKey}&units=metric`).then(showSearchCityWeatherDetails);
}
...
function showSearchCityWeatherDetails(response) {
  ...
  document.querySelector("#humidity").innerHTML = `Hunidity: ${response.data.main.humidity} %`;
